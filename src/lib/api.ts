...
const fallbackProducts: Product[] = [
  ...
  },
  {
    ...
    description:
      "Set of 3 minimalist ceramic planters in varying sizes with bamboo saucers.",
    price: 45.99,
    image:
      "https://images.unsplash.com/photo-1622547748225-3fc4abd2cca0?q=80&w=1000&auto=format&fit=crop",
    category: "Home Decor",
